package kz.iitu.courses.security;
...
public class BogdanovBogdanUserDetailsService implements UserDetailsService {
    private final BogdanovBogdanUserRepository userRepository;

    @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        BogdanovBogdanUser user = userRepository.findByEmail(username)
